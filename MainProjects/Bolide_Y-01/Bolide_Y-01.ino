...
static int vector[4] = {125, 125, 125, 125};
...
void loop() {
  ...
  //play sequence edited by motion editor
    ...
    if (Serial2.available() > 0) {
      ...
      if (packet[1] != 255 && packet[2] != 1) {
        if (vector[0] <= 155 && vector[0] >= 95 && vector[1] <= 155 && vector[1] >= 95 && vector[2] <= 155 && vector[2] >= 95 && vector[3] <= 155 && vector[3] >= 95) {
          // Button task
          BUTTON_Task();
        }
        else {

          if ((vector[0] > 155 && vector[1] > 155 && vector[0] > vector[1]) | (vector[0] > 155 && vector[1] < 95 && (vector[0] - 155) > (95 - vector[1])) | (vector[0] > 155 && vector[1] >= 95 && vector[1] <= 155)) {
            //LeftJoystick_Rightside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_LJR);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[0] < 95 && vector[1] > 155 && (95 - vector[0]) > (vector[1] - 155)) | (vector[0] < 95 && vector[1] < 155 && (95 - vector[0]) > (95 - vector[1])) | (vector[0] < 95 && vector[1] >= 95 && vector[1] <= 155)) {
            //LeftJoystick_Leftside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_LJL);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[0] > 155 && vector[1] > 155 && vector[0] < vector[1]) | (vector[0] < 95 && vector[1] > 155 && (95 - vector[0]) < (vector[1] - 155)) | (vector[1] > 155 && vector[0] >= 95 && vector[0] <= 155)) {
            //LeftJoystick_Upside
            if (Adjustment_index) {
              if (Falling_Task() == 5) {
                if (Avoidance_index && IR_SENSOR_Task() < 20) {
          ...
          else if ((vector[0] > 155 && vector[1] < 95 && (vector[0] - 155) < (95 - vector[1])) | (vector[0] < 95 && vector[1] < 95 && (95 - vector[0]) < (155 - vector[1])) | (vector[1] < 95 && vector[0] >= 95 && vector[0] <= 155)) {
            //LeftJoystick_Downside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_LJD);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[2] > 155 & vector[3] > 155 && vector[2] > vector[3]) | (vector[2] > 155 && vector[3] < 95 && (vector[2] - 155) > (95 - vector[3])) | (vector[2] > 155 && vector[3] >= 95 && vector[3] <= 155)) {
            //RightJoystick_Rightside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_RJR);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[2] < 95 && vector[3] > 155 && (95 - vector[2]) > (vector[3] - 155)) | (vector[2] < 95 && vector[3] < 95 && (95 - vector[2]) > (95 - vector[3])) | (vector[2] < 95 && vector[3] >= 95 && vector[3] <= 155)) {
            //RightJoystick_Leftside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_RJL);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[2] > 155 && vector[3] > 155 && vector[2] < vector[3]) | (vector[2] < 95 && vector[3] > 155 && (95 - vector[2]) < (vector[3] - 155)) | (vector[3] > 155 && vector[2] >= 95 && vector[2] <= 155)) {
            //RightJoystick_Upside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_RJU);
              else Getup_Task(Falling_Task());
          ...
          else if ((vector[2] > 155 && vector[3] < 95 && (vector[2] - 155) < (95 - vector[3])) | (vector[2] < 155 && vector[3] < 95 && (95 - vector[2]) < (95 - vector[3])) | (vector[3] < 95 && vector[2] >= 95 && vector[2] <= 155)) {
            //RightJoystick_Downside
            if (Adjustment_index) {
              if (Falling_Task() == 5) Action(RCU_RJD);
              else Getup_Task(Falling_Task());
...
void Packet_Version_Read(void) {
  ...
  Serial.write(type_humanoid);                //Type
...
void BT_FW() {
  ...
  delay(50);
  Serial2.write(0x42);  // Robot Model ASCII code : 0x42 for Bolide
  delay(50);
  Serial2.write(0x01);  // Robot Type : 0x1 for Y-01
  delay(50);
  Serial2.write(0x44);  // Application ASCII code : 0x44 for Default ; 0x54 for Tickle
  delay(50);
