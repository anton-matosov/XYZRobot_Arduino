...
mkdir -p "$rootDir/XYZSharedProjects/hardware/XYZrobot/Current"
ln -sf "$rootDir/XYZSharedProjects/hardware/XYZrobot/1.6/avr/" "$rootDir/XYZSharedProjects/hardware/XYZrobot/Current/XYZrobot/"
